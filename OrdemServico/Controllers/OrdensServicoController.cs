...
namespace OrdemServico.Controllers
{
    public class OrdensServicoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdDefeito"] = new SelectList(_context.Defeitos, "IdDefeito", "IdDefeito");
            ViewData["IdEquipamento"] = new SelectList(_context.Equipamentos, "IdEquipamento", "IdEquipamento");
        ...
        public async Task<IActionResult> Create([Bind("IdOrdemServico,DataOrdemServico,Servico,ValorTotal,StatusServico,IdEquipamento,IdCliente,IdDefeito,IdTecnico")] OrdensServico ordensServico)
        {
            ...
            ViewData["IdCliente"] = new SelectList(_context.Clientes, "IdCliente", "IdCliente", ordensServico.IdCliente);
            ViewData["IdDefeito"] = new SelectList(_context.Defeitos, "IdDefeito", "IdDefeito", ordensServico.IdDefeito);
            ViewData["IdEquipamento"] = new SelectList(_context.Equipamentos, "IdEquipamento", "IdEquipamento", ordensServico.IdEquipamento);
            ViewData["IdTecnico"] = new SelectList(_context.Tecnicos, "IdTecnico", "IdTecnico", ordensServico.IdTecnico);
            return View(ordensServico);
        }
